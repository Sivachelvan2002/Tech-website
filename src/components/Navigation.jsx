...
export default function Navigation() {
  ...
  return (
    <div className='relative'>
        <nav className='mycontainer w-full h-24 bg-[#0a0a0a] border-b border-green-500 shadow  flex flex-row justify-between items-center text-sm md:text-md fixed z-50'>
        ...
        {menuStatus && (
  <div
    className={`md:hidden bg-[#0a0a0a] px-6 py-4 space-y-4 text-white flex flex-col justify-center items-center font-bold absolute top-0 w-full min-h-[80vh] z-30
      transition-left duration-500 ease-in-out 
      ${menuStatus ? "left-0" : "left-[100%]"}`}
  >
